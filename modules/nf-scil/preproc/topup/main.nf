...
process PREPROC_TOPUP {
    ...
    then
        ...
        scil_dwi_extract_b0.py $dwi $bval $bvec ${prefix}__b0_mean.nii.gz --mean --b0_thr $b0_thr_extract_b0 --force_b0_threshold
    fi
    ...
    then
        ...
        scil_dwi_extract_b0.py $rev_dwi $rev_bval $rev_bvec ${prefix}__rev_b0_mean.nii.gz --mean --b0_thr $b0_thr_extract_b0 --force_b0_threshold
    fi
